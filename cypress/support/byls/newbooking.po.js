export class BookingPage{
    ...
    static getParking=()=> cy.get('.jss66 > .MuiButtonBase-root > .MuiBox-root > .MuiTypography-root')
    ...
    static getSessionValue = ()=> cy.contains('Massage')
    ...
    static conformBooking =()=> cy.contains('Request to book')
